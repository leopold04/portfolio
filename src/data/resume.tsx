...
export const DATA = {
  ...
  description: "Aspiring software engineer and hiking enthusiast",
  summary:
    "I'm a senior at Cornell studying computer science in the College of Engineering. My main interests lie in backend development, machine learning, and robotics. Although I have experience teaching computer science and robotics to a younger audience and plan to continue in giving back, I also plan on remaining a lifelong learner.",
  avatarUrl: "/me.png",
  skills: ["Python", "Typescript", "Go", "Postgres", "Docker", "Java", "C++"],
  navbar: [
    { href: "/", icon: HomeIcon, label: "Home" },
    { href: "/blog", icon: NotebookIcon, label: "Blog" },
  ],
  contact: {
    email: "leopolddorilas@gmail.com",
    tel: "+123456789",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/leopold04",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/leopold-d/",
        icon: Icons.linkedin,
        navbar: true,
      },
    },
  ...
  work: [
    {
      ...
      description:
        "Worked on the SRE/DevOps team. Built internal tooling to centralize our development and production environment information and eliminate the need to manually restart services on our Google Compute Engine instances.",
    },
    {
      company: "iD Tech",
      badges: [],
      ...
      location: "Remote",
      title: "ML and Robotics Instructor",
      logoUrl: "/id.png",
      start: "May 2024",
      end: "Aug 2024",
      description: "Taught children about AI and how to make remote controlled robots that can fight",
    },
    {
      company: "Code Wiz",
      ...
      badges: [],
      location: "Needham, MA",
      title: "Computer Science and Robotics Instructor",
      logoUrl: "/cw.png",
      start: "May 2022",
      end: "Aug 2022",
      description: "Made a curriculum to teach Python and basic robot construction for elementary schoolers",
    },
  ],
  education: [
    {
  ...
  projects: [
    {
      title: "MotionLab",
      href: "https://motionlab.app",
      dates: "Nov 2024 - May 2025",
      active: true,
      description:
        "I saw there was a fair amount of demand for the creation of short form physics simulation videos, so I made a webapp to automate that process for non-technical people. 163 users and $40 in revenue",
      technologies: ["Python", "Flask", "Stripe", "FFmpeg", "React", "Typescript", "Supabase"],
      links: [
        {
          type: "Website",
          href: "https://motionlab.app",
        ...
        {
          type: "Source",
          href: "https://github.com/leopold04/MotionLab",
